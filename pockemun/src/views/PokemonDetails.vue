<template>
  <div
    class="flex items-center justify-center transition-all duration-800"
    :class="{
      'opacity-0 translate-y-12': animationFlag === false,
      'opacity-100 translate-y-0': animationFlag === true
    }"
  >
    <div class="grid grid-cols-10 mt-10 mb-10">
      ...
      <div
        v-else
        role="status"
        class="justify-center justify-items-center p-10 col-span-8 col-start-2 bg-red-300 rounded-3xl"
      >
        <svg
          aria-hidden="true"
          class="inline w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-red-600"
          viewBox="0 0 100 101"
          fill="none"
